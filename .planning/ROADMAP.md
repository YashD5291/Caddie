...
- [ ] **Phase 18: Screen Capture Engine** - Standalone `ScreenRecorder` writes a crash-safe, bitrate-capped HEVC `.mov` with timing anchors
...
| 18. Screen Capture Engine | v3.0 | 1/4 | In Progress|  |
